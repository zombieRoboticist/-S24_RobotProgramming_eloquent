...
class Metaclass_GoToPoint_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('draw_shape_interfaces')
        except ImportError:
            import logging
            import traceback
...
class GoToPoint_Request(metaclass=Metaclass_GoToPoint_Request):
    ...
    _fields_and_field_types = {
        'desired_pose': 'geometry_msgs/Point',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Point
        self.desired_pose = kwargs.get('desired_pose', Point())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.desired_pose != other.desired_pose:
            return False
        return True
    ...
    def desired_pose(self):
        """Message field 'desired_pose'."""
        return self._desired_pose

    @desired_pose.setter
    def desired_pose(self, value):
        if __debug__:
            from geometry_msgs.msg import Point
            assert \
                isinstance(value, Point), \
                "The 'desired_pose' field must be a sub message of type 'Point'"
        self._desired_pose = value
...
class Metaclass_GoToPoint(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'draw_shape_interfaces.srv.GoToPoint')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from draw_shape_interfaces.srv import _go_to_point
...
class GoToPoint(metaclass=Metaclass_GoToPoint):
    from draw_shape_interfaces.srv._go_to_point import GoToPoint_Request as Request
    from draw_shape_interfaces.srv._go_to_point import GoToPoint_Response as Response
