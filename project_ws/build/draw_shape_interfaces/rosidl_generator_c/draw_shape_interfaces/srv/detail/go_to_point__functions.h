...
#ifndef DRAW_SHAPE_INTERFACES__SRV__DETAIL__GO_TO_POINT__FUNCTIONS_H_
#define DRAW_SHAPE_INTERFACES__SRV__DETAIL__GO_TO_POINT__FUNCTIONS_H_
 ...
 * calls
 * draw_shape_interfaces__srv__GoToPoint_Request__init().
...
/**
 * It calls
 * draw_shape_interfaces__srv__GoToPoint_Request__fini()
...
/// Check for srv/GoToPoint message equality.
/**
 ...
 * draw_shape_interfaces__srv__GoToPoint_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * draw_shape_interfaces__srv__GoToPoint_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GoToPoint message array equality.
/**
...
/// Copy an array of srv/GoToPoint messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * draw_shape_interfaces__srv__GoToPoint_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_draw_shape_interfaces
...
/**
 * It calls
 * draw_shape_interfaces__srv__GoToPoint_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_draw_shape_interfaces
...
/**
 * It allocates the memory for the array and calls
 * draw_shape_interfaces__srv__GoToPoint_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_draw_shape_interfaces
...
/**
 * It calls
 * draw_shape_interfaces__srv__GoToPoint_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DRAW_SHAPE_INTERFACES__SRV__DETAIL__GO_TO_POINT__FUNCTIONS_H_
