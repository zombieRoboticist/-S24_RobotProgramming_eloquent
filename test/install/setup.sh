...
_colcon_prefix_chain_sh_COLCON_CURRENT_PREFIX=/home/yahboom/S24_RobotProgramming_eloquent/test/install
...
# setting COLCON_CURRENT_PREFIX avoids relying on the build time prefix of the sourced script
COLCON_CURRENT_PREFIX="/home/yahboom/S24_RobotProgramming_eloquent/roscourse_sim_ws/install"
_colcon_prefix_chain_sh_source_script "$COLCON_CURRENT_PREFIX/local_setup.sh"
