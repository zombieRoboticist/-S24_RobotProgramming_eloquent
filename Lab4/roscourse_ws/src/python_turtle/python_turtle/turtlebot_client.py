...
class TurtleClient(Node):
    def __init__(self):
        ...
        #adding parameters and descriptions
        self.declare_parameter('turtleColor', 'red', ParameterDescriptor(description='The color of the turtle at startup'))
        self.declare_parameter('penSize', 5, ParameterDescriptor(description='The pen size of the turtle'))

        #changing color of the turtle
        ...
        #Avoiding pen color disruption from server
...
def main(args=None):
    ...
    while rclpy.ok():
        ...
        #commented out below code to allow for teleop control: John Marcotte Feb 26, 2024
        #### publish twist ####
        # cmd_msg = Twist()
